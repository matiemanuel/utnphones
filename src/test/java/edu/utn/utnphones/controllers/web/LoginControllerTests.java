...
public class LoginControllerTests {
    ...
    public void init() {
        ...
        when(userController.login(userNotExist.getEmail(), userNotExist.getPassword())).thenThrow(UserNotExistsException.class);
    ...
    @Test
    public void loginOkTest() throws InvalidLoginException {
    ...
    public void loginInvalidUserTest() throws InvalidLoginException {
        LoginRequestDto request = new LoginRequestDto(userNotExist.getEmail(), userNotExist.getPassword());
        loginControlller.login(request);
    }

    @Test(expected = InvalidLoginException.class)
    public void loginInvalidPasswordTest() throws InvalidLoginException {
        LoginRequestDto request = new LoginRequestDto(correctUser.getEmail(), userNotExist.getPassword());
        loginControlller.login(request);
    }
